...
Construido en la Hackathon "IA-Hackathon GOV-TECH de Croma" usando Croma API como fuente de datos.
...
Datos	Croma API (RUES, SECOP, Contraloría, Procuraduría)
Compartido	shared/ — tipos de nodo/arista comunes entre frontend y backend
Ver CLAUDE.md para la arquitectura completa, el modelo de datos del grafo y el roadmap del hackathon.
...
Requisitos
Node.js 20+
Una API key de Croma (opcional — sin ella el backend sirve datos de prueba automáticamente vía MOCK_MODE)
Backend
cd backend
...
El frontend queda protegido por un login simple (usuario/contraseña fijos, definidos en backend/.env) — ver sección 10 de CLAUDE.md.
...
Equipo
Carlos chaparro lopez - Samuel Prada - jesus Florez 
